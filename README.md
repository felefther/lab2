...
Στα γραφήματα που ακολουθούν βλέπουμε και το συσχετισμό μεταξύ των παραγόντων και της απόδοσης του συστήματος.Σε κάθε ένα έχουμε κρατήσει συγκεκριμές μεταβλητές σταθερές έτσι ώστε να φανεί καλύτερα ποιές μεταβλητές επηράζουν ποιό αποτέλεσμα.
